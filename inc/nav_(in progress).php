...
<header <?php if( is_front_page() && ! is_home() ) { ?>class="pattern-bg"<?php } ?>>
  ...
  <div class="pt-20 max-w-7xl mx-auto px-6 lg:py-9 lg:flex content-end items-end" data-toggle>
    ...
    <div class="navigation grow lg:h-14">
      ...
      <!-- Primary Nav -->
      <nav class="menu primary pt-12 lg:pt-0 <?php if( is_front_page() && ! is_home() ) { ?>text-white<?php } else { ?>text-midnight-500<?php } ?>">
  ...
  <!-- Hero -->
  <section id="hero">
    <div class="max-w-7xl mx-auto px-6 py-16 pt-24 lg:pt-48 lg:pr-56">
