  ...
  <section id="meta" class="max-w-4xl mx-auto px-6 mb-12 lg:mb-16">
    <div class="grid md:grid-cols-2 items-center">
      <div class="author flex items-center">
        <div class="avatar lg:avatar-featured mt-6 mr-4">
        ...
        <div class="text text-sm lg:text-base">
          ...
          <a href="/about/team/<?php the_author_meta('nickname'); ?>?href=title" title="Find out more about <?php the_author(); ?>"  class="inline-block pt-6"><?php the_author(); ?></a>
          </h2>
